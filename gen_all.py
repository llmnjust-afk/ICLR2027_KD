...
CONFIGS = [
    ...
    # IPC=50
    ("imagenet100", 100, "/root/data/imagenet100/", "./results/sweep_in100", "ipc50_unguided", 50, True, 0.0, 0.05, 0.3, False, "constant"),
    ("imagenet100", 100, "/root/data/imagenet100/", "./results/sweep_in100", "ipc50_cagsv2_0.0_0.06", 50, False, 0.1, 0.0, 0.06, False, "constant"),
    # IPC=10
    ("imagenet100", 100, "/root/data/imagenet100/", "./results/sweep_in100", "unguided", 10, True, 0.0, 0.05, 0.3, False, "constant"),
    ("imagenet100", 100, "/root/data/imagenet100/", "./results/sweep_in100", "fixed_l0.1", 10, True, 0.1, 0.05, 0.3, False, "constant"),
    ("imagenet100", 100, "/root/data/imagenet100/", "./results/sweep_in100", "cagsv2_0.0_0.06", 10, False, 0.1, 0.0, 0.06, False, "constant"),
    ("imagenet100", 100, "/root/data/imagenet100/", "./results/sweep_in100", "tags_linear_cagsv2", 10, False, 0.1, 0.0, 0.06, False, "linear"),
    # IPC=1
    ("imagenet100", 100, "/root/data/imagenet100/", "./results/sweep_in100", "ipc1_unguided", 1, True, 0.0, 0.05, 0.3, False, "constant"),
    ("imagenet100", 100, "/root/data/imagenet100/", "./results/sweep_in100", "ipc1_cagsv2_0.0_0.06", 1, False, 0.1, 0.0, 0.06, False, "constant"),
    ("imagenet100", 100, "/root/data/imagenet100/", "./results/sweep_in100", "iast_cagsv2_0.0_0.06", 1, False, 0.1, 0.0, 0.06, True, "constant"),
    # === ImageNet-10 (10 classes from IN100) — 8 configs ===
    # IPC=50
    ("imagenet100", 10, "/root/data/imagenet100/", "./results/sweep_in10", "ipc50_unguided", 50, True, 0.0, 0.05, 0.3, False, "constant"),
    ("imagenet100", 10, "/root/data/imagenet100/", "./results/sweep_in10", "ipc50_cagsv2_0.0_0.06", 50, False, 0.1, 0.0, 0.06, False, "constant"),
    # IPC=10
    ("imagenet100", 10, "/root/data/imagenet100/", "./results/sweep_in10", "fixed_l0.0", 10, True, 0.0, 0.05, 0.3, False, "constant"),
    ("imagenet100", 10, "/root/data/imagenet100/", "./results/sweep_in10", "fixed_l0.05", 10, True, 0.05, 0.05, 0.3, False, "constant"),
    ("imagenet100", 10, "/root/data/imagenet100/", "./results/sweep_in10", "cagsv2_0.0_0.08", 10, False, 0.1, 0.0, 0.08, False, "constant"),
    # IPC=1
    ("imagenet100", 10, "/root/data/imagenet100/", "./results/sweep_in10", "ipc1_unguided", 1, True, 0.0, 0.05, 0.3, False, "constant"),
    ("imagenet100", 10, "/root/data/imagenet100/", "./results/sweep_in10", "ipc1_cagsv2_0.0_0.06", 1, False, 0.1, 0.0, 0.06, False, "constant"),
    ("imagenet100", 10, "/root/data/imagenet100/", "./results/sweep_in10", "iast_cagsv2_0.0_0.08", 1, False, 0.1, 0.0, 0.08, True, "constant"),
    # === ImageNette (10 classes) — 2 configs ===
    ("nette", 10, "/root/data/imagenette2/", "./results/sweep_nette", "unguided", 10, True, 0.0, 0.05, 0.3, False, "constant"),
    ("nette", 10, "/root/data/imagenette2/", "./results/sweep_nette", "cagsv2_0.0_0.06", 10, False, 0.1, 0.0, 0.06, False, "constant"),
    # === ImageWoof (10 classes) — 2 configs ===
    ("woof", 10, "/root/data/imagewoof2/", "./results/sweep_woof", "unguided", 10, True, 0.0, 0.05, 0.3, False, "constant"),
    ("woof", 10, "/root/data/imagewoof2/", "./results/sweep_woof", "cagsv2_0.0_0.06", 10, False, 0.1, 0.0, 0.06, False, "constant"),
]
...
CLUSTER_SPECS = [
    ("imagenet100", 100, "/root/data/imagenet100/", "./results/sweep_in100"),
    ("imagenet100", 10, "/root/data/imagenet100/", "./results/sweep_in10"),
    ("nette", 10, "/root/data/imagenette2/", "./results/sweep_nette"),
    ("woof", 10, "/root/data/imagewoof2/", "./results/sweep_woof"),
]
