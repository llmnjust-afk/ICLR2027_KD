...
\caption{\cags{} vs.\ unguided across all evaluated settings. Green bars indicate \cags{} configurations with positive relative gain; red indicates degradation. \cags{} provides consistent, substantial improvements on the 100-class subset ($+7.6\%$ to $+17.0\%$ relative) and at 10-class IPC=50 ($+7.9\%$), while the degradation on ImageWoof ($-5.2\%$) confirms the complexity-variation boundary condition.}
