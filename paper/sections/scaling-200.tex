...
\begin{table}[t]
\centering
\caption{Scaling analysis: \cags{} advantage grows with class count. All experiments use IPC=10, instance normalization. Epochs: 3000 for 10-class, 2000 for 44--200 classes, 1000 for 1000 classes. Seeds: 3 for $\leq$200 classes, 3 for 1000-class ResNet-18 and ResNetAP-10, 2 for 1000-class ConvNet-6. The \cags{} advantage increases from $+1.19\%$ (44 classes) to $+6.97\%$ (1000 classes, ResNet-18), confirming the scaling hypothesis.}
\label{tab:scaling}
