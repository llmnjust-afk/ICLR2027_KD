#!/bin/bash
# AGS-DD: Generate distilled dataset on ImageNette
# Usage: bash scripts/run_imagenette.sh [IPC] [CKPT_PATH]
...
SAVE_DIR="./generated/ags_dd/nette_ipc${IPC}"
...
echo "=================================================="
echo "AGS-DD: Generating ImageNette dataset (IPC=${IPC})"
echo "=================================================="
